...
the exact lot rows behind the aggregate basis. The dedicated WorkOS application is registered; post-deploy live
proof against the deterministic `personal-tax-walkthrough` seed remains on
#166. IRS e-file and a CPA portal remain refused. The Project AIA
