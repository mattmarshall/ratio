...
\begin{tikzpicture}[
  ...
  io/.style={font=\sffamily\footnotesize, text=ratioAccent, align=center},
  comp/.style={rounded corners=2pt, draw=ratioMid, fill=ratioTint,
...
\node[font=\fontsize{30}{30}\selectfont\bfseries, text=ratioRule] at (0,-0.2) {?};
...
\draw[->, ratioAccent] (lin) -- (lb.west);
\draw[->, ratioAccent] (lb.east) -- (lout);

% ── Right: Ratio glass box ──
\begin{scope}[xshift=11.2cm]
\node[rectangle, rounded corners=5pt, draw=ratioAccent, line width=1pt,
      fill=ratioRule!35, minimum width=50mm, minimum height=34mm] (rb) at (0,0) {};
...
\draw[->, ratioAccent] (rin) -- (rb.west);
\draw[->, ratioAccent] (rb.east) -- (rout);
\end{scope}
\end{tikzpicture}%
}
\caption*{\small\color{ratioAccent}\sffamily Legacy engines are opaque: identical
