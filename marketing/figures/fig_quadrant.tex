...
\begin{tikzpicture}[
  ...
  dot/.style={circle, fill=ratioAccent, inner sep=2pt},
  lbl/.style={font=\sffamily\footnotesize, text=ratioInk},
]
% Desirable quadrant shading (top-right)
\fill[ratioRule!45, rounded corners=2pt] (3,3) rectangle (6,6);
\node[align=center, text=ratioAccent, font=\sffamily\bfseries\small] at (4.5,5.55)
...
\end{tikzpicture}
\caption*{\small\color{ratioAccent}\sffamily Ratio's positioning view. Incumbents
