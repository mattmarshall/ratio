...
|---|---|---|
| Personal | `bank-statement`, `loan-payment`, `brokerage-statement`, `brokerage-positions`, `ecb-reference-rates` | `living_expense`, `household_income`, `card_charge`, transfers, `spend_*`, `receive_income`, named-loan interest/principal, `forecast_*`, `scheduled_*` |
