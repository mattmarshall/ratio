...
open dial, unused Cognito CloudFormation resources, and live provider
OAuth. This file does not close #150.
...
1. **API authorizer accepts Connect access tokens** with these scopes —
   ...
   CloudFormation resources, and live provider OAuth — not the
   in-process grant.
