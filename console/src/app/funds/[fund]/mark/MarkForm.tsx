  ...
  const steps: Step[] = [
    {
      ...
      ask: "As at what day?",
      why: [
        "Each position moves by the difference between what the book holds it at and what it is worth.",
        "The contra is unrealized gain.",
        "A posting, not an assignment: nothing is overwritten, so \"why is this worth more than we paid\" has an entry to point at.",
      ],
    ...
    },
    {
      ...
      why: [
        "A position with no price on or before the date is not marked at zero.",
        "It is reported unpriced, and it blocks.",
