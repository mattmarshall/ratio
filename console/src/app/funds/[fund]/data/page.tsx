    ...
    <>
      <div className="qbar" role="group" aria-label="Data">
        ...
        <span className="sortnote">
          <Link href={`/funds/${fund}/ingest`}>Read a file</Link>
          {" · "}
          <Link href={`/funds/${fund}/data/templates`}>Templates</Link>
        </span>
      </div>
        ...
        {deliveries.map((d) => {
          ...
          return (
            <Link
              ...
              key={d.name}
              href={`/funds/${fund}/data/deliveries/${id}`}
            >
        ...
        {pendingFacts.map((p) => {
          ...
          return (
            <Link
              ...
              key={p.name}
              href={`/funds/${fund}/data/pending/${id}`}
            >
              <span
