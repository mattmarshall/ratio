 ...
 *
 * ⭐ KIND SELECTS THE PLACES. A project book that listed Exceptions / NAV
 * would be a fake label on fund-ops screens. The hub is how you open the
 * citable billed-vs-earned and retainage figures after CreateBook.
 */
