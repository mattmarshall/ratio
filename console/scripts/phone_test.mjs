...
const SCREENS = [
  ...
  [`/books/${F}/views/abor/nav`, "main"],
  ["/books/household/views/book/loans", "main"],
  ["/books/household/views/book/bridge", "main"],
  ["/books/household/views/book/cashflow", "main"],
  ["/books/studio/views/book/cashflow", "main"],
  ["/books/studio/views/book/aging", "main"],
  ...
  [`/books/${F}/ingest`, "main"],
  [`/books/${F}/mark`, "main"],
  ["/books/household", "main"],
  ["/books/household/views/book/sheet", "main"],
  ["/books/household/views/book/pnl", "main"],
  ["/books/household/views/book/close", '[aria-label="Period close"]'],
  ["/books/studio/views/book/sheet", "main"],
  ["/books/studio/views/book/pnl", "main"],
  ["/books/studio/views/book/close", '[aria-label="Period close"]'],
  ["/books/household/transfer", "main"],
  [`/books/${F}/config`, "main"],
