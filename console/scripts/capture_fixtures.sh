...
# The journal entry every posting cites — #52. Id from the captured posting,
# not a hard-coded one: a seed that renumbers entries would otherwise leave
# this file pointing at a row the book no longer has.
