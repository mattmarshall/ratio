...
| Flow | When | Endpoint |
|---|---|---|
| `authorization_code` | User-actor first-party apps (audit-export, lp-portal, fund-ops-alerts, bank-rec, tax-pack, bank-feed, …) | `{WORKOS_CONNECT_ISSUER}/oauth2/authorize` then `POST …/oauth2/token` |
