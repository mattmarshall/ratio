...
(#150 / leftover #22). Write-route actor binding landed (#151).
...
def deliver(
    ...
    *,
    ...
    A green mapper is not a door that opens. Connect access tokens
    are not accepted on /v1. This function exists so a caller cannot
